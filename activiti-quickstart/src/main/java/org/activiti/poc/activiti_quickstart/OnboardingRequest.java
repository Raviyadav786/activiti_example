...
/*
		...
		ProcessEngineConfiguration cfg = new StandaloneProcessEngineConfiguration()
				.setJdbcUrl("jdbc:oracle:thin:@localhost:1521:xe").setJdbcUsername("SYSTEM").setJdbcPassword("ravi")
		...
		Deployment deployment = repositoryService.createDeployment().addClasspathResource("processes/bpmn20.xml")
				.deploy();
